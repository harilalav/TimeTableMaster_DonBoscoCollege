...
public class Tuesday {
    ...
    public Tuesday(String sub1, String sub2, String sub3,
                   String sub4, String sub5, String sub6,
                   String sub7, String sub1Teacher, String sub2Teacher,
                   String sub3Teacher, String sub4Teacher, String sub5Teacher,
                   String sub6Teacher, String sub7Teacher, String fT1, String tT1,
                   String fT2, String tT2, String fT3, String tT3, String fT4, String tT4,
                   String fT5, String tT5, String fT6, String tT6, String fT7, String tT7) {
        this.sub1 = sub1;
        this.sub2 = sub2;
        this.sub3 = sub3;
        this.sub4 = sub4;
